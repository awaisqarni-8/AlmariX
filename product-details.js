      ...
      <div class="productDetails">
        ...
        <div class="info">
          ...
          <h2 style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            <span style="font-size:30px; font-weight:700; color:#ff6a00;">
              PKR ${discountedPrice}
            </span>
            <span style="background:#ef4444; color:white; font-size:13px; font-weight:700; padding:4px 10px; border-radius:5px;">
              40% OFF
            </span>
          </h2>  
...
window.addToCart = () => {
  ...
  const discountedPrice = Math.round((product.price || 0) * 0.6);
