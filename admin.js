...
window.editProduct = async (id) => {
  ...
  snapshot.forEach((item) => {
    ...
    if (item.id === id) {
      ...
      document.getElementById("productSize1").value = product.size1 || "";

      document.getElementById("productSize2").value = product.size2 || "";

      document.getElementById("productSize3").value = product.size3 || "";

      document.getElementById("productColor1").value = product.color1 || "";

      document.getElementById("productColor2").value = product.color2 || "";
